...
namespace ClinicSystem.Core.Features.Appointments.Commands.Validatiors
{
    public class EditAppointmentValidatior : AbstractValidator<EditAppointmentCommand>
    {
        ...
        public EditAppointmentValidatior(IPatientCaseService patientCaseService,
            IDoctorService doctorService, IAppointmentStatusService appointmentStatusService)
        {
